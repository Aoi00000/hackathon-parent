...
AI Flea Market は、通常のフリマアプリに AI による購買支援、出品支援、価格交渉支援、生活相談、販売改善通知を組み込んだ「次世代フリマアプリ」です。登録、ログイン、出品、検索、商品詳細、コメント、非公開DM、チェックリスト、購入、発送、受け取り評価、通知、マイページ、支払い方法、残高チャージ、売上管理までを一連の流れとして動かせます。
